...
{
    public class EcUseButton : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private buttonAction ButtonAction = buttonAction.M3;

        private enum buttonAction { M1, M2, M3, M4, M5, M6, M7, Reset, Grow, Shrink };
        bool was = false;
        private Vector3 InitialScale;
        public static EcUseButton CUBInstance;
        public int press = 0;
