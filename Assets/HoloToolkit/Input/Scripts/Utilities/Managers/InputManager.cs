...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class InputManager : Singleton<InputManager>
    {
        ...
        /// </summary>
        [Obsolete("Will be removed in a future release.  If you need to know if a specific pointer should send Unigty UI Events use FocusManager.Instance.GetSpecificPointerEventData()!=null")]
