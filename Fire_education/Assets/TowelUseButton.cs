...
{
    public class TowelUseButton : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private buttonAction ButtonAction = buttonAction.M4;
        bool was = false;
        private enum buttonAction { M1, M2, M3, M4, M5, M6, M7, Reset, Grow, Shrink };
        public static TowelUseButton CUBInstance;
        public int press = 0;
